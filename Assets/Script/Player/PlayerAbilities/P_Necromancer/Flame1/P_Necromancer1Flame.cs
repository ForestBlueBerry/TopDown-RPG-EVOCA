...
[CreateAssetMenu(menuName = "Scriptable Objects/PlayerAbilities/NecromancerAb1Flame")]
public class P_Necromancer1Flame : PlayerAbilities
{
    ...
    public override void Activate(GameObject parent, Vector2 mousePos)
    {
        ...
        GameObject ab = GameObject.Instantiate(abilkaPrefab, (Vector2)parent.transform.position + dir * offset, Quaternion.Euler(0, 0, angle));
