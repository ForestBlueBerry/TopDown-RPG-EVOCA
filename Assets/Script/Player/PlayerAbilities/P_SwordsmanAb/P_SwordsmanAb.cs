using UnityEngine;
[CreateAssetMenu(menuName = "Scriptable Objects/PlayerAbilities/AbSwordsmen")]
public class P_SwordsmanAb : PlayerAbilities
{
    ...
    public override void Activate(GameObject parent, Vector2 mousePos)
    {
        ...
        GameObject abilka = GameObject.Instantiate(prefabAb, (Vector2)parent.transform.position + dir*offset,Quaternion.Euler(0,0,angle-45));
